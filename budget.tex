...
\begin{tikzpicture}[remember picture,overlay]
  \begin{scope}[on background layer]
    \node[anchor=north west,outer sep=0,inner sep=0] (img) at (current page.north west) {\includegraphics[width=21cm]{images/city/palace-2.jpg}};
  \end{scope}
  \node[anchor=south west,color=black,xshift=1ex,yshift=1ex] (label) at (img.south west) {\imgtitle{datenhamster.org}{Karlsruhe Palace}{“Panorama Schloss Karlsruhe”, CC BY-NC-ND 2.0, \url{https://www.flickr.com/photos/nasebaer/}}};
  \begin{scope}[on background layer]
...
As we do not know the cost for the different venues at this point, we are unable
to correctly plan the whole budget at this point. This budget should still
provide some insights into the cost and spending structure for GUADEC in
Karlsruhe. The “Best Case” and “Worst Case” options show how we might react
to higher costs for the venue or lower income. Some of the “Best Case” entries
show lower spending as we may be able to get/provide the service at a better
price.
...
\hspace*{1em} Venue  & -1000.00 & -4500.00 & -8000.00\\
...
\hspace*{1em} \hspace*{1em} Coffee Breaks & -400.00 & -700.00 & {–}\\
...
\bf Sum \hspace*{1em}  & 9025.00 & -700.00 & -6050.00\\
\end{tabularx}
