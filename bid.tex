...
%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{description}
    \item[CC BY-SA 2.0] \url{https://creativecommons.org/licenses/by-sa/2.0/}
    ...
    \item[CC BY-NC-SA 2.0] \url{https://creativecommons.org/licenses/by-nc-sa/2.0/}
    \item[CC BY-NC-ND 2.0] \url{https://creativecommons.org/licenses/by-nc-nd/2.0/}
  \end{description}
