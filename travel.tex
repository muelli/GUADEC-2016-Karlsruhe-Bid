...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[anchor=south east,outer sep=0ex,xshift=-1ex,yshift=1ex,color=black] (label) at (img.south east) {\imgtitle{Günter Josef Radig}{Karl-Friederich Memorial and Palace}{“Karl-Friedrich-Denkmal am Schlossplatz in Karlsruhe”, CC BY-SA 3.0 DE, cropped, \url{https://commons.wikimedia.org/wiki/File:Karl-Friedrich-Denkmal_am_Schlossplatz_Karlsruhe_(cropped).JPG}}};
\end{tikzpicture}
