...
%\begin{tikzpicture}[remember picture,overlay]
%  \node[anchor=north west,outer sep=0,inner sep=0] (img) at (current page.north west) {\includegraphics[width=21cm,trim=0 190 0 100,clip]{images/city/palace-3.jpg}};
%  \node[anchor=south west,outer sep=1ex,color=white] at (img.south west) {\imgtitle{Günter Josef Radig}{Karlsruhe Palace}{“Karl-Friedrich-Denkmal am Schlossplatz in Karlsruhe”, CC BY-SA 3.0 DE, \url{https://commons.wikimedia.org/wiki/File:Karl-Friedrich-Denkmal_am_Schlossplatz_Karlsruhe_(cropped).JPG}}};
%\end{tikzpicture}
