...
Notes Benjamin:
 * guess the last sentence is a conclusion of the bid. Will need to see if that fits when layouted
 * University Canteen is only this cheap for students because of subsidees, we cannot guarantee this price for our guests (even student)!
 * 6 Euro per meal with or without drinks? (pretty hard with drink, even if possible)
 * Do *NOT* name any Restaurants, fine to say something "if you know where to go you can find …"
