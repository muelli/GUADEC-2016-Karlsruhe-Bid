...
\begin{tikzpicture}[remember picture,overlay]
  \begin{scope}[on background layer]
    \node[anchor=north west,outer sep=0,inner sep=0] (img) at (current page.north west) {\includegraphics[width=9.5cm,angle=-90]{images/venues/kit/kit-1.jpg}};
    \node[anchor=north west,outer sep=0,inner sep=0,xshift=-1pt] (img-2) at (img.north east) {\includegraphics[height=9.5cm]{images/venues/kit/1050-1.jpg}};
  \end{scope}
